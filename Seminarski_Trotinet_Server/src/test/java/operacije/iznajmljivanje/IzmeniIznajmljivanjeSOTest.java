 ...
 * @author nikola
 */
public class IzmeniIznajmljivanjeSOTest {
    
    private IzmeniIznajmljivanjeSO operacija;
    private Iznajmljivanje iznajmljivanje;

    @BeforeEach
    void setUp() {
        operacija = new IzmeniIznajmljivanjeSO();
    ...
    void testPreduslovNull() {
        ...
        assertEquals("Sistem nije mogao da izmeni iznajmljivanje", e.getMessage());
    }
